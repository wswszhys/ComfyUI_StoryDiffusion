...
def process_generation(
        ...
        load_chars,
        lora,
        trigger_words, begin_words, end_words, photomake_mode, use_kolor, use_flux, make_dual_only, kolor_face, pulid, story_maker,
    ...
    prompts = [begin_words + "," + item + "," + end_words  for item in prompts]
...
class Storydiffusion_Model_Loader:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "begin_words": ("STRING", {"default": ""}),
                "end_words": ("STRING", {"default": ""}),
    ...
    def story_model_loader(self,character_prompt, repo_id, ckpt_name, vae_id, character_weights, lora, lora_scale,controlnet_model, clip_vision,trigger_words,begin_words,end_words, sampeler_name, scheduler,
        ...
        model={"pipe":pipe,"use_flux":use_flux,"use_kolor":use_kolor,"photomake_mode":photomake_mode,"trigger_words":trigger_words,"begin_words":begin_words,"end_words":end_words,"lora_scale":lora_scale,
...
class Storydiffusion_Sampler:
    ...
    def story_sampler(self, model,scene_prompts, negative_prompt, img_style, seed, steps,
        ...
        begin_words=model.get("begin_words")
        end_words=model.get("end_words")
        ...
        if model_type=="img2img":
            ...
            gen = process_generation(pipe, image_load, model_type, steps, img_style, denoise_or_ip_sacle,
                                     ...
                                     load_chars,
                                     lora,
                                     trigger_words,begin_words,end_words,photomake_mode,use_kolor,use_flux,make_dual_only,
            ...
            gen = process_generation(pipe, upload_images, model_type, steps, img_style, denoise_or_ip_sacle,
                                     ...
                                     load_chars,
                                     lora,
                                     trigger_words,begin_words,end_words,photomake_mode,use_kolor,use_flux,make_dual_only,kolor_face,
        ...
        if prompts_dual:
            ...
            if story_maker:
                ...
                prompts_dual = [begin_words + "," + item + "," + end_words  for item in prompts_dual]
